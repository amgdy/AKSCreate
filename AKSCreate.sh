...
serverApplicationId=${serverApplicationId//$'\r'}
echo export serverApplicationId=$serverApplicationId >>./var.txt
echo -e "$GREEN Waiting for APP to be created..."
sleep 5
echo -e "$GREEN Updating App!..."
az ad app update --id $serverApplicationId --set groupMembershipClaims=All
az ad sp create --id $serverApplicationId 
echo -e "$GREEN Creating SP for app...."
...
echo -e "$GREEN Adding permissions to ServerApplication...."
...
clientApplicationId=$(az ad app create \
    ...
    --query appId -o tsv)
clientApplicationId=${clientApplicationId//$'\r'}
